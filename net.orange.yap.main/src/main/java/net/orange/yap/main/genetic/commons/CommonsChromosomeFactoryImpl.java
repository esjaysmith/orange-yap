 ...
 * Time: 20:52
 */
public class CommonsChromosomeFactoryImpl implements ChromosomeFactory {

    private final EvaluationStrategy evaluation;

    public CommonsChromosomeFactoryImpl(EvaluationStrategy evaluation) {
    ...
    public Chromosome createChromosome(Program program) {
        return new CommonsChromosome(program, evaluation);
    }
}
